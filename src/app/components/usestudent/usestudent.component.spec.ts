...
import { UsestudentComponent } from './usestudent.component';
...
fdescribe('UsestudentComponent', () => {
 ...
 //TEST 1 
 it('TEST:1 CREAR COMPONENTE USESTUDAINTE', () => {    
